...
[![version](https://img.shields.io/badge/version-0.2.5-4f8cff)](#-安装)
...
```sh
opkg install cf-auto_0.2.5_x86_64.ipk    # x86_64 软路由
opkg install cf-auto_0.2.5_aarch64.ipk   # ARM64 设备（N1 等）
```
...
```powershell
.\build.ps1 -Version 0.2.5    # 自动下载引擎并交叉编译双架构 ipk
```
