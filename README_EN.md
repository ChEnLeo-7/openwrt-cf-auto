...
[![version](https://img.shields.io/badge/version-0.2.7-4f8cff)](#installation)
...
```sh
opkg install cf-auto_0.2.7_x86_64.ipk    # x86_64 router
opkg install cf-auto_0.2.7_aarch64.ipk   # ARM64 device, such as an N1
```
...
```powershell
.\build.ps1 -Version 0.2.7    # Download the engine and cross-compile both IPK architectures
```
