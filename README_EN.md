...
[![version](https://img.shields.io/badge/version-0.3.4-4f8cff)](#installation)
...
- 🌎 **Country-code filtering**: enter an ISO two-letter country code such as `US|United States` to cover all known Cloudflare colos in that country.
...
```sh
opkg install cf-auto_0.3.4_x86_64.ipk    # x86_64 router
opkg install cf-auto_0.3.4_aarch64.ipk   # ARM64 device, such as an N1
```
...
```powershell
.\build.ps1 -Version 0.3.4    # Download the engine and cross-compile both IPK architectures
```
