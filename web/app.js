...
const I18N = {
  zh: {
    ...
    "cfg.region_h":"区域定向（真实落地机房）","cfg.region_en":"启用区域过滤","cfg.colo_ph":"输入机房代码或国家代码，可附 |名称（如 US|美国）","cfg.add":"添加","cfg.region_hint":"可单选或多选；每个地区独立测速。输入 ISO 两字母国家代码（如 US）会覆盖该国已知 Cloudflare 机房；按钮显示“代码 | 地区”解释。","cfg.min_region":"每地区最少上榜数",
  ...
  en: {
    ...
    "cfg.region_h":"Region targeting (real edge colo)","cfg.region_en":"Enable region filtering","cfg.colo_ph":"Enter a colo or country code, optionally |Name (e.g. US|United States)","cfg.add":"Add","cfg.region_hint":"Select one or more entries; each is tested separately. An ISO two-letter country code such as US expands to its known Cloudflare colos. Buttons show “code | location”.","cfg.min_region":"Minimum results per region",
